...
const dark = { bg: "#0f0f11", card: "rgba(255,255,255,0.03)", border: "rgba(255,255,255,0.08)", muted: "rgba(255,255,255,0.35)", faint: "rgba(255,255,255,0.12)" };
...
function ScoreReveal({ scores, onSave, saving }: { scores: EmotionScores; onSave: () => void; saving: boolean }) {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
      ...
      <div className="flex items-center justify-between">
        <div>
          <p className="text-xs text-white/40 uppercase tracking-wider mb-1">Today&apos;s mood score</p>
...
export default function JournalPage() {
  ...
  return (
    <div className="flex flex-col h-screen" style={{ background: dark.bg }}>
      ...
      {emotionScores && !saved && <ScoreReveal scores={emotionScores} onSave={saveEntry} saving={saving} />}
